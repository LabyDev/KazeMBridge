...
def _finalize(half: bytearray) -> bytes:
...
def decode(b64: str) -> dict:
    ...
    FAN_MAP = {0x07: 0, 0x00: 1, 0x01: 2, 0x02: 3, 0x06: 4}
    fan = FAN_MAP.get(r[3] & 0x0F, 0)
    VPOS_MAP = {0x00: 1, 0x10: 2, 0x20: 3, 0x30: 4}
    wind_ud = 0 if vert_swing else VPOS_MAP.get(r[3] & 0x30, 1)
